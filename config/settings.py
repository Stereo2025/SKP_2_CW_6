...
SECRET_KEY = 'django-insecure-3@iqo6eud8)^lzgw84)&h#xzy(g&*vuz7jc)^v-qrft)1q!jo-'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'mailings/static'),
]
STATIC_ROOT = os.path.join(BASE_DIR, 'mailings/staticfiles')
MEDIA_URL = '/media/'
